      ...
      <table class="w-full">
        ...
        <tbody>
          <tr v-for="a in items" :key="a.id" class="border-b border-gray-100 hover:bg-gray-50">
            ...
            <td class="px-4 py-3 text-sm text-gray-700">{{ a.rule_name }}</td>
            <td class="px-4 py-3 text-sm text-gray-500">{{ a.host_name || a.host_ip }}</td>
            <td class="px-4 py-3 text-sm font-mono">{{ a.current_value }}</td>
            <td class="px-4 py-3 text-sm font-mono text-gray-400">{{ a.threshold }}</td>
            <td class="px-4 py-3 text-xs text-gray-400">{{ a.triggered_at }}</td>
            <td class="px-4 py-3">
