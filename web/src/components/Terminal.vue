<template>
  <div class="terminal-panel" :class="{ collapsed: isCollapsed }" :style="{ height: isCollapsed ? 'auto' : panelHeight + 'px' }">
    <!-- Resize Handle -->
    ...
    <div class="terminal-header">
      ...
      <div class="terminal-header-right">
        ...
        <button class="terminal-btn" @click="toggleCollapse" :title="isCollapsed ? '展开' : '折叠'">
    ...
    <!-- Terminal Body -->
    <div v-if="!isCollapsed" class="terminal-body">
      <!-- Log Area -->
