...
def build_system_prompt(mode: str, host_context: dict, stage: str, metrics_text: str = "", hosts_context: list[dict] | None = None, available_tools_text: str = "", memory_text: str = "") -> str:
