...
from aios.echo import echo_agent, echo_router, init_echo_db
...
async def startup_event():
    ...
    # -- AIOS initialization --
    from aios.tools import init_tool_registry
    _tr = init_tool_registry()
    logger.info("AIOS ToolRegistry initialized (%d base tools)", len(_tr.get_base_tools()))
